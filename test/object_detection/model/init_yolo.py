...
from data.data_loader import load_partition_data_coco, load_entire_training_data_coco, load_entire_test_data_coco
...
def init_yolo(args, device="cpu"):
    ...
    # dataset_val = load_entire_test_data_coco(args, hyp, model)
    # [
    #     # train_data_num,
    #     test_data_num,
    #     # train_data_global,
    ...
    return model, dataset, dataset_train, trainer, args
